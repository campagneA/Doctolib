...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XuaBd4Crtd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ncl+Lg0vDc', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kkU-dJBaYA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xQhOG6rdIw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('djj13pSwh-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oeLzvpKQ8s', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lgEKW5aVM5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder49449 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerbd642 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties490e7 = [
        
    ];

    public function getConnection()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getConnection', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getMetadataFactory', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getExpressionBuilder', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'beginTransaction', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getCache', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getCache();
    }

    public function transactional($func)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'transactional', array('func' => $func), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->transactional($func);
    }

    public function commit()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'commit', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->commit();
    }

    public function rollback()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'rollback', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getClassMetadata', array('className' => $className), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'createQuery', array('dql' => $dql), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'createNamedQuery', array('name' => $name), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'createQueryBuilder', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'flush', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'clear', array('entityName' => $entityName), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->clear($entityName);
    }

    public function close()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'close', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->close();
    }

    public function persist($entity)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'persist', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'remove', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'refresh', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'detach', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'merge', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getRepository', array('entityName' => $entityName), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'contains', array('entity' => $entity), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getEventManager', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getConfiguration', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'isOpen', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getUnitOfWork', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getProxyFactory', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'initializeObject', array('obj' => $obj), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'getFilters', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'isFiltersStateClean', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'hasFilters', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return $this->valueHolder49449->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerbd642 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder49449) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder49449 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder49449->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, '__get', ['name' => $name], $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        if (isset(self::$publicProperties490e7[$name])) {
            return $this->valueHolder49449->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder49449;
    ...
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;
    ...
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, '__isset', array('name' => $name), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;
    ...
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, '__unset', array('name' => $name), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;
    ...
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, '__clone', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        $this->valueHolder49449 = clone $this->valueHolder49449;
    }

    public function __sleep()
    {
        $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, '__sleep', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;

        return array('valueHolder49449');
    }
    ...
    {
        $this->initializerbd642 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerbd642;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerbd642 && ($this->initializerbd642->__invoke($valueHolder49449, $this, 'initializeProxy', array(), $this->initializerbd642) || 1) && $this->valueHolder49449 = $valueHolder49449;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder49449;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder49449;
    }
}
